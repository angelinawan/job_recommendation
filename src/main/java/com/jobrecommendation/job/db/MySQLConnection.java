...
public class MySQLConnection {
    ...
    // create the connection to MySQL instance
    ...
    public void saveItem(Item item) {
        ...
        String sql = "INSERT IGNORE INTO items VALUES (?, ?, ?, ?, ?)"; //default all columns
        try {
            PreparedStatement statement = conn.prepareStatement(sql);
            ...
            sql = "INSERT IGNORE INTO keywords VALUES (?, ?)"; //'?'item_id '?'keyword_id
    ...
    public Set<String> getFavoriteItemIds(String userId) { //code in this class can be improved
        if (conn == null) {
            System.err.println("DB connection failed");
            return new HashSet<>();
        }
    ...
    public boolean addUser(String userId, String password, String firstname, String lastname) {
        ...
        try {
            ...
            return statement.executeUpdate() == 1; //check if inserted correctly, 1 means one row inserted
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return false;
